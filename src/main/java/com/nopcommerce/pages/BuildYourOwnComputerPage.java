...
public class BuildYoutOwnComputerPage extends Utility {
    @CacheLookup
    ...
    public void selectMicrosoftOfficeOption() throws InterruptedException {
        Thread.sleep(1000);
    ...
    //get Successfully Added To Cart Text
